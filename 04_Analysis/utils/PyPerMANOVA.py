...
def _unequal_var_ttest_denom(v1, n1, v2, n2):   #RHS: as found in:   https://github.com/scipy/scipy/pull/13366/files
    vn1 = v1 / n1
    vn2 = v2 / n2
...
def _calculate_degrees_freedom(matrix,item):
    ...
    #dof, ot = ttest_ind(first_matrix, second_matrix, equal_var=False)   #RHS added 1/5/24
    #print('dof:', dof)
    #print()
    #print("other thing:",ot)
    #print() 
...
def permutational_analysis(data, mapping, column=None, **kwargs):
    ...
    **kwargs :
    ...
    #print("size of dist matrix (this should be like number of samples - not taxa - shouldn't change at diff resolutions: ", len(distance_matrix))
